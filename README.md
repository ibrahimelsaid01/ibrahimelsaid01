...
A full-stack accommodation marketplace built with Angular and ASP.NET Core.

**Key Engineering Highlights:**

- Multi-role architecture for Guests, Hosts, and Administrators
- Angular standalone components with Signals and RxJS
...
- Property and host verification workflows
- Booking lifecycle management
- Stripe payment integration and webhooks
- Cloudinary image and document uploads
- Reviews, wishlists, notifications, and support tickets
- Background services for booking lifecycle processing
...
- Many-to-many Game–Device relationship
- Razor Views and ViewModels
- CRUD operations
- Cover-image upload and validation
- Select2 multi-device selection
- SweetAlert2 interactions
- EF Core migrations and seeded reference data
